<head>
    ...
    <link href="estilos-pedidos.css" rel="stylesheet" type="text/css">
...
<body>
    <nav>
        <div class="logo">
            <h2><a href="../index-empleado/index-empleado.html" class="nombre"> GGod </a></h2>
        </div>
        <ul class="navs">
            <li><a href="../index-empleado/index-pedidos.php">Pedidos </a></li>
            <li><a href="../index-empleado/index-productos.php">Productos </a></li>
            <li><a href="../index-empleado/index-seguimiento.php">Seguimento</a></li>
            <li><a href="../index-empleado/carrito.php"> 
...
if(!$resultado3 = $conexion -> query($select_pedidos2)){
    ...
    echo" <div class='tab'><table class='tablau'><th>ID</th><th>ID Usuario</th><th>Fecha</th><th>Direccion deenvio</th><th>estado</th>";
